                                                                                                                                                                ...
                                                                                                                                                                function(data) {
                                                                                                                                                                    ...
                                                                                                                                                                    $.get('https://api.coingecko.com/api/v3/simple/price?ids=safe2&vs_currencies=usd',
                                                                                                                                                                        function(data) {
                                                                                                                                                                            ...
                                                                                                                                                                            var barn_claim_apr = ((((safe2_price * 39.24) / barn_claim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            ...
                                                                                                                                                                            var cream_claim_apr = ((((safe2_price * 29.43) / cream_claim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            $('#cream_claim_apr').html(cream_claim_apr);
                                                                                                                                                                            var cream_noclaim_apr = ((((safe2_price * 9.81) / cream_noclaim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            $('#cream_noclaim_apr').html(cream_noclaim_apr);

                                                                                                                                                                            var crv_claim_apr = ((((safe2_price * 49.05) / crv_claim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            $('#crv_claim_apr').html(crv_claim_apr);
                                                                                                                                                                            var crv_noclaim_apr = ((((safe2_price * 16.35) / crv_noclaim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            $('#crv_noclaim_apr').html(crv_noclaim_apr);

                                                                                                                                                                            var harvest_claim_apr = ((((safe2_price * 29.43) / harvest_claim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            $('#harvest_claim_apr').html(harvest_claim_apr);
                                                                                                                                                                            var harvest_noclaim_apr = ((((safe2_price * 9.81) / harvest_noclaim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            $('#harvest_noclaim_apr').html(harvest_noclaim_apr);

                                                                                                                                                                            var pick_claim_apr = ((((safe2_price * 39.24) / pick_claim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            ...
                                                                                                                                                                            var ren_claim_apr = ((((safe2_price * 29.43) / ren_claim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            $('#ren_claim_apr').html(ren_claim_apr);
                                                                                                                                                                            var ren_noclaim_apr = ((((safe2_price * 9.81) / ren_noclaim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            $('#ren_noclaim_apr').html(ren_noclaim_apr);

                                                                                                                                                                            var sushi_claim_apr = ((((safe2_price * 39.24) / sushi_claim_tvl) * 100).toFixed(2) + '%');
                                                                                                                                                                            ...
                                                                                                                                                                            var yearn_claim_apr = ((((safe2_price * 39.24) / yearn_claim_tvl) * 100).toFixed(2) + '%');
